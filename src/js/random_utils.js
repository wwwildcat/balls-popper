import {
    MIN_SIZE_RATE, MAX_SIZE_RATE,
    MIN_WIND_DURATION, MAX_WIND_DURATION,
    MIN_WIND_PERIOD, MAX_WIND_PERIOD
} from './constants.js'

const getColor = () =>
    `rgb(${Math.random() * 255}, ${Math.random() * 255}, ${Math.random() * 255})`;

const getGradientCenter = () =>
...
export const getInitialTranslate = (size, totalWidth) =>
    `${Math.random() * (totalWidth - size)}px`;
